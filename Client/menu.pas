...
label1.Caption := 'Добро пожаловать ' + cds_user_id.FieldByName('fio').Value + '!';
label1.Visible := true;
Passw := '';
Login.Hide;
Tasks.Show; }
...
label1.Caption := 'Добро пожаловать ' + cds_user.FieldByName('fio').Value + '!';
label1.Visible := true;
lbe_password.Text := '';
cds_user.Close;
...
showmessage('Введите правильный логин и пароль!');
end;
